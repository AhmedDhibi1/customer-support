...
const WebMastersList = () => {
    ...
    useEffect(() => {
        ...
        const fetchWebMasters = async () => {
            try {
                ...
                const filteredWebMasters = fetchedUsers.filter(user => user.RoleId === 4);
                setWebMasters(filteredWebMasters);
    ...
    const filteredWebMasters = webMasters.filter((webMaster) =>
        webMaster.firstName.toLowerCase().includes(searchTerm.toLowerCase()) ||
        webMaster.lastName.toLowerCase().includes(searchTerm.toLowerCase()) ||
        webMaster.email.toLowerCase().includes(searchTerm.toLowerCase())
    );

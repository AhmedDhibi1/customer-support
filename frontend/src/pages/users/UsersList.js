...
const UsersList = () => {
	...
	useEffect(() => {
		getById(userId).then((response) => {
			...
			const EditPermission = await checkPermission('users-update');
			const DeletePermission = await checkPermission('users-delete');
...
/>          </div>
            ...
            {filteredUsers.map((user) => ( 
                  ...
                  {user.createdAt}
								...
								<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
									...
									<span class="relative">{user.RoleId}</span>
									</span>
								</td>
								<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">	
								{(editPermission&&roleId>=user.RoleId )&& (
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.779 17.779 4.36 19.918 6.5 13.5m4.279 4.279 8.364-8.643a3.027 3.027 0 0 0-2.14-5.165 3.03 3.03 0 0 0-2.14.886L6.5 13.5m4.279 4.279L6.499 13.5m2.14 2.14 6.213-6.504M12.75 7.04 17 11.28"/>
        ...
        <span class="ml-2">Edit</span>
								 ...
								 <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
								 {(deletePermission&&roleId>=user.RoleId) &&
            ...
            <span class="ml-2">Delete</span>
					...
					<div
						...
						<div class="inline-flex mt-2 xs:mt-0">
							<button
                                class="text-sm text-gray-50 transition duration-150 hover:bg-gray-500 bg-gray-600 font-semibold py-2 px-4 rounded-l">
                                Prev
                            </button>
							&nbsp; &nbsp;
							<button

...
import { createTicketItem } from "../../api/services/ticketItem/ticketItem.api";
...
const CreateTicketItem = () => {
 ...
 const handleSubmit = async (e) => {
    ...
    try {
      const response = await createTicketItem(ticketItemData);
      if (response) {
          ...
          <div className="p-4 col-span-6 md:col-span-4">
            <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-10">
              <div className="col-span-2">
                <h1 className="text-3xl m-10 font-bold text-gray-800">Create Ticket Item</h1>
              </div>
              <div className="col-span-2 ">
            ...
            {Success && <SuccessAlert message="Ticket item created successfully" />}
...
export default CreateTicketItem;
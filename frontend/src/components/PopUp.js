...
function PopUp({ isOpen, onConfirm, onCancel, title, message }) {
    if (!isOpen) return null;
   
    return ReactDOM.createPortal(
        <div>         
        <div className="fixed inset-0 bg-gray-500 bg-opacity-25 transition-opacity backdrop-filter backdrop-blur-md" aria-hidden="true"></div>
